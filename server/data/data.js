export const kpis = [
  {
    ...
    dailyData: [
      { date: "2022-01-02", revenue: "$1498.94", expenses: "$11430.64" },
      { date: "2022-01-03", revenue: "$935.08", expenses: "$11329.32" },
      { date: "2022-01-04", revenue: "$1350.96", expenses: "$1562.49" },
      { date: "2022-01-05", revenue: "$1244.33", expenses: "$5679.32" },
      { date: "2022-01-06", revenue: "$1132.99", expenses: "$5439.80" },
      { date: "2022-01-07", revenue: "$1158.31", expenses: "$5336.12" },
      { date: "2022-01-08", revenue: "$1184.66", expenses: "$5516.10" },
      { date: "2022-01-09", revenue: "$637.32", expenses: "$5635.06" },
      { date: "2022-01-10", revenue: "$1315.21", expenses: "$5560.12" },
      { date: "2022-01-11", revenue: "$1093.06", expenses: "$5540.05" },
      { date: "2022-01-12", revenue: "$1477.77", expenses: "$5487.16" },
      { date: "2022-01-13", revenue: "$1076.09", expenses: "$6616.29" },
      { date: "2022-01-14", revenue: "$1130.96", expenses: "$1392.17" },
      { date: "2022-01-15", revenue: "$846.42", expenses: "$6548.38" },
      { date: "2022-01-16", revenue: "$1182.35", expenses: "$366.72" },
      { date: "2022-01-17", revenue: "$1046.61", expenses: "$9481.56" },
      ...
      { date: "2022-01-22", revenue: "$1447.38", expenses: "$12476.59" },
      { date: "2022-01-23", revenue: "$1194.96", expenses: "$12482.85" },
      { date: "2022-01-24", revenue: "$713.11", expenses: "$98754.33" },
      { date: "2022-01-25", revenue: "$1084.48", expenses: "$56547.37" },
      { date: "2022-01-26", revenue: "$819.53", expenses: "$653.59" },
      { date: "2022-01-27", revenue: "$1306.61", expenses: "$636.87" },
      { date: "2022-01-28", revenue: "$1029.78", expenses: "$5719.46" },
      ...
      { date: "2022-02-07", revenue: "$824.40", expenses: "$9743.82" },
      ...
      { date: "2022-03-23", revenue: "$1044.45", expenses: "$9704.07" },
      ...
      { date: "2022-04-02", revenue: "$1347.49", expenses: "$9079.95" },
      ...
      { date: "2022-11-05", revenue: "$557.25", expenses: "$89667.31" },
